# T-0001: Baseline Verification and Regression Documentation
...
|----|-------------|-------|
| T-0001-1 | Run pytest and document results | DONE |
| T-0001-2 | Run behave and document results | DONE |
| T-0001-3 | Run pyright and ruff | DONE |
| T-0001-4 | Test existing test-files | DONE |
| T-0001-5 | Test WOTAN/example-docs | DONE |
| T-0001-6 | Create baseline report | DONE |
