# T-0004: Implement mc:AlternateContent Handling
...
|----|-------------|-------|
| T-0004-1 | Add mc and v namespaces | DONE |
| T-0004-2 | Create MCE OXML classes | DONE |
| T-0004-3 | Create TextBox proxy classes | DONE |
| T-0004-4 | Add text_boxes to Document | DONE |
| T-0004-5 | Implement dual-write sync | PARTIAL (placeholder) |
| T-0004-6 | Write tests | DEFERRED |
